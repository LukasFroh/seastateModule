...
if n==2
     cmap =  [0.5686    0.8118    0.3765;
              0.8902    0.2902    0.2000];
          return;
end
if n == 3
     cmap =  [0.5686    0.8118    0.3765;
              0.9451    0.6392    0.2510;
              0.8902    0.2902    0.2000];
    return;
end
...
cmapp = [165,0,38; 215,48,39; 244,109,67; 253,174,97; 254,224,139; 255,255,191; 217,239,139; 166,217,106; 102,189,99; 26,152,80; 0,104,55];
