function [lonInput,latInput,varInputScaledFinal,fig1] = plt_adjustedSeastate(input,GSHHG,spatialData,siteData,plotType,cbType)
%% :::::::::| Description |::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
switch plotType
    ...
    case 'wam'
        ...
        ax1 = gca;
        % Spatial plot
        plt_spatialPlot(ax1,input,cmDeep,lonInput,latInput,varInputFinal,cfLevels,GSHHG,cbTicks,fsAxis,coastColor,edgeColor);
        % Set title
    ...
    case 'adj'
        ...
        hold on
        ax2 = gca;
        ax2 = plt_spatialPlot(ax2,input,cmDeep,lonInput,latInput,varInputScaledFinal,cfLevels,GSHHG,cbTicks,fsAxis,coastColor,edgeColor);
        % Set title
    ...
    case 'both'
        ...
        ax2 = gca;
        % Spatial plot
        plt_spatialPlot(ax2,input,cmDeep,lonInput,latInput,varInputScaledFinal,cfLevels,GSHHG,cbTicks,fsAxis,coastColor,edgeColor);
        % Set title
        title(['Adj. | ' datestr(input.time2Eval,'yyyy-mm-dd HH:MM')],'FontSize',fsTitle)
    ...
    case 'adjInfo'
        ...
        ax1 = gca;
        % Spatial plot
        plt_spatialPlot(ax1,input,cmDeep,lonInput,latInput,varInputScaledFinal,cfLevels,GSHHG,cbTicks,fsAxis,coastColor,edgeColor);
        % Plot site indication
        plt_plotSites(siteData,validSitesIdx,siteMarkerSize,textColorInsitu,fsAxis)
        % Set title
        title(['Adj. | ' datestr(input.time2Eval,'yyyy-mm-dd HH:MM')],'FontSize',fsTitle)
        % Plot statistics from insitu / Wam comparison (3 free tiles in tiled layout mandatory)
